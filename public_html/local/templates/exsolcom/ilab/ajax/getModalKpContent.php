...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$res = CIBlockElement::GetList([], ['IBLOCK_ID' => 9], false, false,
		['PROPERTY_I_CONTENT_LINK', 'PROPERTY_I_CONTENT_LINK_EN', 'PROPERTY_I_CONTENT_LINK_KZ', 'ID', 'CODE' , 'NAME',
            'PREVIEW_PICTURE', 'DETAIL_PICTURE', 'PREVIEW_TEXT', 'PROPERTY_I_PRICE']
